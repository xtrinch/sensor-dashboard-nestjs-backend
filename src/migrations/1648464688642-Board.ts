...
export class Board1648464688642 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "display_sensors_sensor" ADD CONSTRAINT "FK_970234925bc87567e162d2ad327" FOREIGN KEY ("displayId") REFERENCES "display"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "display_sensors_sensor" ADD CONSTRAINT "FK_7fcb19e5bf1fb2e83817dbaa41f" FOREIGN KEY ("sensorId") REFERENCES "sensor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
