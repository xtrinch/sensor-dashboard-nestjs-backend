...
export class MeasurementToFloat41608999915447 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "measurement" ALTER COLUMN measurement TYPE real`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "measurement" DROP COLUMN "measurement"`);
        await queryRunner.query(`ALTER TABLE "measurement" ADD "measurement" double precision NOT NULL`);
    }
